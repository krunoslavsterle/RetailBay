...
namespace RetailBay.Infrastructure.EntityFramework.Migrations.Migrations.TenantDB
{
    ...
    [Migration("20191102193305_OrderForAnonymous")]
    partial class OrderForAnonymous
    {
            ...
            modelBuilder.Entity("RetailBay.Core.Entities.TenantDB.Cart", b =>
                {
                    ...
                    b.HasIndex("ShippingAddressId")
                        .HasName("ix_cart_shipping_address_id");
            ...
            modelBuilder.Entity("RetailBay.Core.Entities.TenantDB.Cart", b =>
                {
                    b.HasOne("RetailBay.Core.Entities.Identity.Address", "ShippingAddress")
                        ...
                        .HasConstraintName("fk_cart_address_shipping_address_id");
